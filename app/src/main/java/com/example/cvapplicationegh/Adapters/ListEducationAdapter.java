...
public class ListEducationAdapter extends ArrayAdapter {


    public ListEducationAdapter(Context context, List objects) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            convertView = inflater.inflate(R.layout.items_list_profile_educ, null);
        }
